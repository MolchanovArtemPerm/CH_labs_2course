...
namespace CH_Lab11
{
    public class Trial : IRandomInit, IComparable<Trial>, ICloneable
    {
        ...
        public static Trial InputTrial()
        {
            ...
            result = Program.GetInt("Введите оценку: ", "Ошибка, неправильный ввод.\n", (int num) => num >= 2 && num <= 5);
            return new Trial(subject_surname, subject_name, result);
        }
        ...
        public override bool Equals(object obj)
        {
            return (obj is Trial && (((Trial)obj).subject_surname == this.subject_surname) 
                && (((Trial)obj).subject_name == this.subject_name) 
                && (((Trial)obj).result == this.result));
        }
